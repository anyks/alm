 ...
 */
const float anyks::LEV::minimum(const float x, const float y, const float z) const {
 ...
 * @return   самое минимальное значение из 3-х чисел
 */
const u_short anyks::LEV::minimum(const u_short x, const u_short y, const u_short z) const {
	// Определяем минимальное значение
	return lvmin(lvmin(x, y), z);
}
/**
 ...
 */
const float anyks::LEV::weighted(const string & first, const string & second, const weighter_t * weighter) const {
	// Объявляем конвертер
 ...
 * @return          вес сравниваемого слова
 */
const float anyks::LEV::weighted(const wstring & first, const wstring & second, const weighter_t * weighter) const {
	/**
	 ...
	 * @return          вес сравниваемого слова
	 */
	auto calc = [this](const wstring & first, const wstring & second, const weighter_t * weighter = nullptr){
	 ...
	 * @return  вес символа
	 */
	defWeighter.ins = [](const wchar_t a){return float(0.6f);};
	/**
	 * Функция для определения веса при удалении
	 * @param a символ удаления
	 * @return  вес символа
	 */
	defWeighter.del = [](const wchar_t a){return float(0.55f);};
	/**
	 ...
	 * @return  вес символа
	 */
	defWeighter.rep = [](const wchar_t a, const wchar_t b, const wchar_t c, const wchar_t d){
 ...
 */
const float anyks::LEV::tanimoto(const string & first, const string & second, const u_short stl) const {
	// Результат работы функции
	float result = 0.0f;
 ...
 * @return        коэффициент Танимото
 */
const float anyks::LEV::tanimoto(const wstring & first, const wstring & second, const u_short stl) const {
	// Результат работы функции
	float result = 0.0f;
	// Если первое и второе слово переданы
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::mulct(const string & pattern, const string & text) const {
	// Результат работы функции
	u_short result = 0;
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::mulct(const wstring & pattern, const wstring & text) const {
	// Результат работы функции
	u_short result = 0;
	// Если шаблон для сравнения и исходный текст переданы
	if(!pattern.empty() && !text.empty()){
		 ...
		 * @return  вес символа
		 */
		weighter.ins = [](const wchar_t a){return 2.0f;};
		/**
		 * Функция для определения веса при удалении
		 * @param a символ удаления
		 * @return  вес символа
		 */
		weighter.del = [](const wchar_t a){return 2.0f;};
		/**
		 * Функция для определения веса при замене
		 * @param a заменяемый символ
		 * @param b символ замены
		 * @return  вес символа
		 */
		weighter.rep = [](const wchar_t a, const wchar_t b, const wchar_t c, const wchar_t d){
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::damerau(const string & pattern, const string & text) const {
	// Результат работы функции
	u_short result = 0;
	// Если шаблон для сравнения и исходный текст переданы
	if(!pattern.empty() && !text.empty()){
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::damerau(const wstring & pattern, const wstring & text) const {
	// Результат работы функции
	u_short result = 0;
	// Если шаблон для сравнения и исходный текст переданы
	if(!pattern.empty() && !text.empty()){
		 ...
		 * @return  вес символа
		 */
		weighter.ins = [](const wchar_t a){return 1.0f;};
		/**
		 * Функция для определения веса при удалении
		 * @param a символ удаления
		 * @return  вес символа
		 */
		weighter.del = [](const wchar_t a){return 1.0f;};
		/**
		 * Функция для определения веса при замене
		 * @param a заменяемый символ
		 * @param b символ замены
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::distance(const string & pattern, const string & text) const {
	// Результат работы функции
	u_short result = 0;
	// Если шаблон для сравнения и исходный текст переданы
	if(!pattern.empty() && !text.empty()){
 ...
 * @return         дистанция
 */
const u_short anyks::LEV::distance(const wstring & pattern, const wstring & text) const {
	// Результат работы функции
	u_short result = 0;
	// Если шаблон для сравнения и исходный текст переданы
	if(!pattern.empty() && !text.empty()){
 ...
 */
const int anyks::LEV::needlemanWunsch(const string & first, const string & second, const int match, const int mismatch, const int gap) const {
	// Результат работы функции
	int result = -1000000;
	// Если слова переданы
	if(!first.empty() && !second.empty()){
 ...
 * @return         количество очков
 */
const int anyks::LEV::needlemanWunsch(const wstring & first, const wstring & second, const int match, const int mismatch, const int gap) const {
	// Результат работы функции
	int result = -1000000;
	// Если слова переданы
	if(!first.empty() && !second.empty()){
